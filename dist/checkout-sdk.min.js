...
c?c:this.expectedFormSections()};return $.ajaxQueue({url:this._getRemoveOfferingsURL(b,a),type:"POST",contentType:"application/json; charset=utf-8",dataType:"json",data:JSON.stringify(c)})};b.prototype.updateItems=function(a,b,c){var d=this;null==b&&(b=this.expectedFormSections());a={orderItems:a,expectedOrderFormSections:b};void 0!==this.requestingItem&&(this.requestingItem.abort(),console.log("Abortando",this.requestingItem));return this.requestingItem=$.ajaxQueue($.extend({url:this._getUpdateItemURL(),
type:"POST",contentType:"application/json; charset=utf-8",dataType:"json",data:JSON.stringify(a)},c)).done(function(){return d.requestingItem=void 0})};b.prototype.removeItems=function(a){var b,c=this;b=$.Deferred();(a?$.when(a):this.getOrderForm(["items"]).then(function(a){return a.items})).then(function(a){return c.updateItems(_(a).map(function(a,b){return{index:a.index,quantity:0}}).reverse()).done(function(a){return b.resolve(a)}).fail(b.reject)});return b.promise()};b.prototype.addDiscountCoupon=
